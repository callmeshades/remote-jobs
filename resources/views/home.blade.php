<x-layouts.default>
    {{-- Hero Section --}}
    <x-container class="bg-white py-12">
        <div class="text-center mb-12">
            ...
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="{{ route('jobs.index') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-6 rounded-lg">Browse Jobs</a>
            </div>
        </div>
    ...
    {{-- Features Section --}}
    <x-container class="bg-gray-50 py-12">
        <div class="text-center mb-12">
